...
def get_optimizer(models, mode, args):
    '''Get the desired optimizer

    - Selects and initialises an optimizer with model params.
    ...
    if args.optimizer == 'adam':
        ...
        optimizer = optim.Adam(params_models, lr=lr,
                               weight_decay=wd)

    elif args.optimizer == 'sgd':

        optimizer = optim.SGD(params_models, lr=lr,
        ...
        optimizer = LARS(reduced_params+removed_params, lr=lr,
